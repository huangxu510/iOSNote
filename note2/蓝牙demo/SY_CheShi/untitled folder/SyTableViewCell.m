...
-(void)addUI{
    ...
    _rssiLable = [[UILabel alloc]initWithFrame:CGRectMake(CGRectGetMaxX(_titleLable.frame)+20, CGRectGetMinY(_titleLable.frame), 60, CGRectGetHeight(_titleLable.frame))];
